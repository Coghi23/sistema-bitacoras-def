...
<img src="https://covao.ed.cr/wp-content/uploads/2025/01/Especialidades-logos-05-e1736905518920.webp" alt="Logo COVAOesp" class="logoespecialidad" />
 ...
 <div class="sidebar-item" id="personal-btn" data-bs-toggle="tooltip" title="Manejo de Personal">
            ...
            <div class="sidebar-item" id="recintos-btn" data-bs-toggle="tooltip" title="Gestión de Recintos">
                <div class="icon-circle"><i class="bi bi-building-fill"></i></div>
                <div class="label">Recintos</div>
            </div>

            <div class="submenu-popover" id="submenu-recintos">
                <div class="submenu-arrow"></div>
                
                <a href="{{ asset('recinto') }}" class="submenu-item" style="text-decoration: none;"><i class="bi bi-building"></i> Recintos</a>
                <a href="{{ asset('tipoRecinto') }}" class="submenu-item" style="text-decoration: none;"><i class="bi bi-collection"></i> Tipo de Recinto</a>
                <a href="{{ asset('estadoRecinto') }}" class="submenu-item" style="text-decoration: none;"><i class="bi bi-check-circle"></i> Estado de Recinto</a>
            </div>
