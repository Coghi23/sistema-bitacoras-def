        ...
        <div class="search-bar-wrapper mb-4">
            ...
            <form id="busquedaForm" method="GET" action="{{ route('especialidad.index') }}" class="w-100 position-relative">
                    ...
                    <input type="text" class="form-control"
                        placeholder="Buscar especialidad..." name="busquedaEspecialidad" 
...
if (inputBusqueda && especialidadesList) {
    inputBusqueda.addEventListener('input', function () {
        const valor = inputBusqueda.value.trim().toLowerCase();
        const items = especialidadesList.querySelectorAll('.especialidad-item');
...
if (btnLimpiar && inputBusqueda && especialidadesList) {
