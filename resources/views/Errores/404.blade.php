...
<body>
    ...
    <div class="error-container">
        <img src="https://cdn-icons-png.flaticon.com/512/2748/2748558.png" alt="Error 404" class="error-img" />
        <div class="error-code">404</div>
        <div class="error-message">¡Oops! Página no encontrada</div>
        <div class="error-description">
            La página que estás buscando no existe, fue eliminada o está temporalmente fuera de servicio.
        </div>
