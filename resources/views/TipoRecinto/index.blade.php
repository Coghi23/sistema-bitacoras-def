    ...
    <div class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div class="input-group w-50">
                ...
                <input type="text" class="form-control border-start-0 shadow-sm" style="border-radius: 20px;" placeholder="Buscar tipo de recinto..." />
            </div>
            <button class="btn btn-primary rounded-pill px-4 d-flex align-items-center" 
                ...
                title="Agregar Tipo de Recinto" style="background-color: #134496; font-size: 1.2rem;">
